...
(function($) {
	...
	$.fn.dlshouwen.grid.lang['zh-cn'] = {
		...
		buttons : {
			...
			edit: '<i class="fa fa-edit"></i>&nbsp;&nbsp;编辑',
			del: '<i class="fa fa-trash-o"></i>&nbsp;&nbsp;删除'
		},
		columnControll : {
			title : "操作"
		},
		validate : {
			defaultAlert : "请正确填写信息！",
			code : "验证码必须由4到8位数字组成",
			tel : "请输入正确的手机号码",
			name : "请输入真实姓名",
			identity : "身份证号码有误，请检查后重新输入",
			password : "密码必须由6到16位数字或字母组成",
			email : "请输入正确的邮箱地址",
			equal : "数据不匹配"
		},
		alert : {
			successTitle : "成功",
			successText : "本次操作成功",
			confirmText : "您确定要删除这条数据？与其相关联的数据也会被删除！",
			confirmTitle : "危险操作",
		...
		toolbar : {
			...
			refreshTitle : '刷新数据',
			newData : '<i class="fa fa-save"></i>',
			newDataTitle : '新增数据',
			importExcel : '<i class="fa fa-upload"></i>',
			importExcelTitle : '导入excel文件',
			fastQuery : '<i class="fa fa-search"></i>',
			fastQueryTitle : '快速查询',
			advanceQuery : '<i class="fa fa-filter"></i>',
			advanceQueryTitle : '高级查询',
			exportExcel : '<i class="fa fa-file-excel-o"></i>',
			exportExcelTitle : '导出excel文件',
			exportCsv : '<i class="fa fa-file-o"></i>',
			exportCsvTitle : '导出csv文件',
			exportPdf : '<i class="fa fa-file-pdf-o"></i>',
			exportPdfTitle : '导出pdf文件',
			exportTxt : '<i class="fa fa-file-o"></i>',
		...
		newData : {
			title : '<i class="fa fa-save"></i>&nbsp;&nbsp;新增',
			buttons : {
				reset : '<i class="fa fa-reply"></i>&nbsp;&nbsp;重置',
				save : '<i class="fa fa-save"></i>&nbsp;&nbsp;新增',
				edit : '<i class="fa fa-edit"></i>&nbsp;&nbsp;编辑'
			}
		},
		advanceQuery : {
