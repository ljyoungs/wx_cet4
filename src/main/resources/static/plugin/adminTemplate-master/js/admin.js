;(function($,undefined){
	...
	window.adminTemplate = {
		...
		generateHead : function(){
    		...
    		var head = '<div id="head"><div class="left">';
    		head += '<a href="javascript:void(0)" class="button profile"><img src="img/icons/top/huser.png" alt="" /></a>';
