var menu = [ {
	name : "听力",
	img : "plugin/adminTemplate-master/img/icons/menu/inbox.png",
	key : "one"
}, {
	name : "阅读",
	img : "plugin/adminTemplate-master/img/icons/menu/layout.png",
	key : "two"
}, {
	name : "写作",
	img : "plugin/adminTemplate-master/img/icons/menu/brush.png",
	key : "three"
} ];
adminTemplate.init({
	menu : menu,
